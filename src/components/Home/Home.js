...
const Home = () => {
    return (
        ...
        <CardDeck>
  <Card>
    <Card.Img variant="top" src={pic1} width="252" height="200" />
    <Card.Body>
  ...
  <Card>
    <Card.Img variant="top" src={pic2} width="252" height="200"  />
    <Card.Body>
  ...
  <Card>
    <Card.Img variant="top" src={pic3} width="252" height="200"  />
    <Card.Body>
